...
class NewGameDlg extends Component {
    ...
    onClickStart = () => {
        this.props.handleSetPlayerName(this.state.player1name, this.state.player2name);
        this.props.onStart(!(this.state.player1name === "" || this.state.player2name === ""));
    }
                ...
                <div className="new-game-dlg-container">
                    ...
                    <DialogContent>
                        <div className="input-group">
                            <label><img className="" src={x_icon}></img> Player 1</label>
                            <input type="text" value={this.state.player1name} onChange={this.onChangePlayer1} />
                        </div>
                        <div className="input-group">
                            <label><img className="" src={o_icon}></img> Player 2</label>
                            <input type="text" value={this.state.player2name} onChange={this.onChangePlayer2} />
                        </div>
                    </DialogContent>
                    <DialogActions>
...
const mapDispatchProps = (dispatch) => {
    return {
        handleSetPlayerName: (player1, player2) => { dispatch(actions.setPlayerName(player1, player2)) }
    };
};
